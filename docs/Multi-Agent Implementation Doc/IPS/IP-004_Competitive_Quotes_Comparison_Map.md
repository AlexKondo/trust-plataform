...
## IP-004 — Competitive Quotes & Comparison Map

**Primary owner:** Marketplace/Experience  
**Hard dependencies:** IP-003

## 1. Objective

Complete multi-offer competition for a Member request. Normalize FIXED_PRICE and HOURLY offers into a comparison model without pretending they are directly identical. Show price model, estimated/committed time, Partner trust/reputation, material assumptions, availability and commercial conditions. Preserve counterproposal and acceptance semantics.
...
No hidden ranking paid placement; no automatic winner; do not convert hourly quote to false fixed total without assumptions.
...
One request can receive multiple eligible offers; Member sees side-by-side comparison; accepted offer freezes PACK-02 terms; losing offers close consistently; E2E covers competition and acceptance.
...
- `IP-004-COMPLETION-REPORT.md` generated from template.
...
```text
Implement IP-004 only.
Do not self-approve.
Do not merge to main.
If blocked, create a Conflict Escalation artifact.
After implementation and tests, generate IP-004-COMPLETION-REPORT.md.
```
