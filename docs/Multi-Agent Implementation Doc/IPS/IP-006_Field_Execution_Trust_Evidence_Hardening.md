...
**Hard dependencies:** IP-001, IP-005

## 1. Objective

Build on PACK-03 Check-in/Pause/Resume/Check-out. Add robust execution UX/API gaps, optional before/after Trust Evidence, evidence metadata/access controls, service notes, completion handoff, and concurrency hardening. Reuse storage. Preserve photos as contextual evidence, not mandatory for every normal service.
...
No automatic computer-vision fraud adjudication; no duplicate evidence subsystem.
...
Execution state transitions race-safe; evidence private and authorized; Service Summary includes relevant evidence; Member/Partner can complete operational journey; tests cover file failures and authorization.
...
- `IP-006-COMPLETION-REPORT.md` generated from template.
...
```text
Implement IP-006 only.
Do not self-approve.
Do not merge to main.
If blocked, create a Conflict Escalation artifact.
After implementation and tests, generate IP-006-COMPLETION-REPORT.md.
```
